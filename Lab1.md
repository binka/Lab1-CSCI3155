...
##Question 1  
  #a 
  The pi at line 4 is bound by line 3 as it is declared within a function one line above it.  
  ...
  #b 
  The x on line 3 is bound by line 2.  This is where the the value x is passed into the function and then used.  
